...
class ScalaClassDefinitionParserSpec extends FlatSpec with Matchers {
  ...
  it should "parse scala class definition" in {
    parseClassDefinitions("class Test extends Test2 with Test3 with Test4") shouldBe
      List(ClassDef("Test", List("Test2", "Test3", "Test4")))
  }

  it should "parse scala class definition with some stuff before it" in {
    parseClassDefinitions("<DELETE_ME> class Test extends Test2 with Test3") shouldBe
      List(ClassDef("Test", List("Test2", "Test3")))
  }

  it should "parse scala class definition with some stuff after it" in {
    parseClassDefinitions("class Test extends Test2 with Test3 <DELETE_ME>") shouldBe
      List(ClassDef("Test", List("Test2", "Test3")))
  }

  it should "parse 2 scala class definitions" in {
    parseClassDefinitions("class Test extends Test2 with Test3 class A extends B with C with D") shouldBe
  ...
  it should "parse 2 scala class definitions with stuff before them" in {
    parseClassDefinitions("<TROLL> class Test extends Test2 with Test3 class A extends B with C with D") shouldBe
      List(ClassDef("Test", List("Test2", "Test3")), ClassDef("A", List("B", "C", "D")))
  }

  it should "parse 2 scala class definitions with stuff between them" in {
    parseClassDefinitions("class Test extends Test2 with Test3 <TROLL> class A extends B with C with D") shouldBe
      List(ClassDef("Test", List("Test2", "Test3")), ClassDef("A", List("B", "C", "D")))
  }

  it should "parse 2 scala class definitions with stuff after them" in {
    parseClassDefinitions("class Test(x: Int) extends Test2(x) with Test3" +
      " class A extends B with C with D <TROLL>") shouldBe
      List(ClassDef("Test", List("Test2", "Test3")), ClassDef("A", List("B", "C", "D")))
  }
